        ...
        <>
            ...
            {/* <Flex justifyContent="center" mb="8">
                <Flex className="chart" flexWrap="wrap" gap="8">
                    <Box className="customer" p="4" rounded="lg" shadow="lg" bg="white">
                        <Heading className="text-xl font-bold mb-4">Customer Reviews</Heading>
                        <Line data={customerReviewData} />
                    </Box>

                    <Box className="orders" p="4" rounded="lg" shadow="lg" bg="white">
                        <Heading className="text-xl font-bold mb-4">Orders</Heading>
                        <Bar data={ordersData} />
                    </Box>

                    <Box className="product" p="4" rounded="lg" shadow="lg" bg="white">
