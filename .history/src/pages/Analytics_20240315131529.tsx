...
const SalesRevenueCard: React.FC = () => {
  ...
  // Calculate the maximum revenue to adjust the height of the bars
  ...
  return (
    <Box boxShadow="xl" p={4} borderRadius="md" w="50%">
      ...
      <Flex direction="column" mt={4}>
        {salesData.map((data) => (
          <Flex key={data.month} align="center" mb={2}>
            <Text>{data.month}</Text>
            <Box bg="blue.200" w={8} h={`${(data.revenue / maxRevenue) * 100}%`} borderRadius="md" ml={2} />
...
const NetProfitOrdersRevenueCard: React.FC = () => {
  ...
  return (
    <Box boxShadow="xl" p={4} borderRadius="md" w="50%">
      ...
      <Flex direction="column" mt={4}>
        <LineChart width={800} height={300} data={combinedData}>
