...
const RevenueCard: React.FC = () => {
  ...
  const increasingRate = ((sales[sales.length - 1].revenue - sales[0].revenue) / sales[0].revenue) * 100;
  ...
  return (
    <Box boxShadow="xl" p={4} borderRadius="md" w="50%">
      ...
      <Text>Total Revenue: ${sales[sales.length - 1].revenue}</Text>
      <Text>Increasing Rate: {increasingRate.toFixed(2)}%</Text>
