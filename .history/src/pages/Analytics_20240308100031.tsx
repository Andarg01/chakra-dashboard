...
const AnalyticsPage: React.FC = () => {
  ...
  return (
    <ChakraProvider>
      <>
        <Box className='text-black font-semibold text-2xl mb-16' textAlign='center'>
          Analytics page
        </Box>

        <SimpleGrid columns={[1, 2, 3]} gap={8} mb={20}>
          <Stat>
            <Box p={4} rounded='lg' shadow='lg' flex='1' mr={4}>
          ...
          <Stat>
            <Box p={4} rounded='lg' shadow='lg' flex='1'>
