...
import { Box, Text, Flex, useColorModeValue, theme } from '@chakra-ui/react';
  ...
  return (
    ...
    >
      <Flex align="center" mb={4}>
        {React.cloneElement(icon, { color: theme.colors.green })} {/* Set icon color to green */}
      ...
      <Box
        ...
        fontSize="sm"
        fontWeight="bold"
        color={isIncreasing ? theme.colors.green : theme.colors.red} {/* Use theme colors */}
      >
