...
const Analytics: React.FC = () => {
  // Sample data for Brand Popularity
  const brandPopularityData = {
    labels: ['Brand A', 'Brand B', 'Brand C', 'Brand D'], // Ensure labels are strings
    datasets: [
      {
        label: 'Popularity',
  ...
  // Sample data for Sales and Revenue
  const salesRevenueData = {
    labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'], // Ensure labels are strings
    datasets: [
      {
        label: 'Sales',
  ...
  return (
    <Flex justifyContent="center" alignItems="center" height="100vh">
      <Box width="80%" boxShadow="xl" p={8} borderRadius="xl"> {/* Extra-large box shadow */}
        <Box mb={8}>
          <Text fontSize="xl" mb={4}>Brand Popularity</Text>
          <Bar data={brandPopularityData} />
        </Box>
        <Box>
          <Text fontSize="xl" mb={4}>Sales and Revenue</Text>
