  ...
  return (
    <Box boxShadow="xl" p={4} borderRadius="md" flex="1" minWidth="200px">
      <Flex align="center">
        ...
        <Text fontSize="xl" ml={2} textAlign="center">Brands</Text>
      </Flex>
  ...
  return (
    <Box boxShadow="xl" p={4} borderRadius="md" flex="1" minWidth="200px">
      <Flex align="center">
        ...
        <Text fontSize="xl" ml={2} textAlign="center">Sales/Revenue</Text>
      </Flex>
...
const NetProfitOrdersRevenueCard: React.FC = () => {
  ...
  return (
    <Box boxShadow="xl" p={4} borderRadius="md" flex="1" minWidth="200px">
      <Flex align="center">
        <Icon as={FaShoppingCart} boxSize={10} color="rgba(0, 100, 0, 0.5)" />
        <Text fontSize="xl" ml={2} textAlign="center">Net Profit, Orders, Revenue</Text>
      </Flex>
      <Flex direction="column" mt={4}>
    ...
    <Flex flexDirection="column" p={4} gap={4}>
      ...
      <Flex direction={{ base: "column", md: "row" }} justify="space-between" gap={4}>
        ...
        <Box boxShadow="xl" p={4} borderRadius="md" flex="1" minWidth="200px">
          <Flex align="center">
            <Icon as={FaShoppingCart} boxSize={10} color="rgba(0, 100, 0, 0.5)" />
            <Text fontSize="xl" ml={2} textAlign="center">Shops</Text>
          </Flex>
          <Text textAlign="center">Total: {shops.length}</Text>
          {shops.map((shop) => (
            <Text key={shop.id} textAlign="center">{shop.name}</Text>
          ))}
        </Box>
        ...
        <Box boxShadow="xl" p={4} borderRadius="md" flex="1" minWidth="200px">
          <Flex align="center">
            ...
            <Text fontSize="xl" ml={2} textAlign="center">Categories</Text>
          </Flex>
          <Text textAlign="center">Total: {categories.length}</Text>
          {categories.map((category) => (
            <Text key={category.id} textAlign="center">{category.name}</Text>
          ))}
        </Box>
        ...
        <Box boxShadow="xl" p={4} borderRadius="md" flex="1" minWidth="200px">
          <Flex align="center">
            ...
            <Text fontSize="xl" ml={2} textAlign="center">Reviews</Text>
          </Flex>
          <Text textAlign="center">Total: {reviews.length}</Text>
          {reviews.map((review) => (
            <Text key={review.id} textAlign="center">Rating: {review.rating}</Text>
          ))}
        </Box>
      </Flex>
