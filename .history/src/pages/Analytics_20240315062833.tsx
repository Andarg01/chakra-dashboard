...
const AnalyticalPage: React.FC = () => {
  ...
  return (
    <Flex justify="space-around">
      {/* Shops */}
      <Box boxShadow="xl" p={4} borderRadius="md">
        <Center>
          <Icon as={FaShoppingCart} boxSize={10} color="darkgreen" />
      ...
      <Box boxShadow="xl" p={4} borderRadius="md">
        <Center>
          <Icon as={FaList} boxSize={10} color="darkgreen" />
      ...
      <Box boxShadow="xl" p={4} borderRadius="md">
        <Center>
          <Icon as={FaStar} boxSize={10} color="darkgreen" />
