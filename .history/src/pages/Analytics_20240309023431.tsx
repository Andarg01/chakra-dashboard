...
const OrderBarChart: React.FC = () => {
  ...
  const [orderData, setOrderData] = React.useState<DataPoint[]>(initialOrderData);

  const sortByValue = () => {
    const sortedData = [...orderData].sort((a, b) => Number(a.value) - Number(b.value));
