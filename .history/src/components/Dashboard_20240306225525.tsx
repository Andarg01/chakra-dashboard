...
import { GiShoppingCart, GiCash, GiReceiveMoney, GiTwoCoins, GiShoppingBag, GiMultipleTargets, IconType } from 'react-icons/gi';
      ...
      <SimpleGrid columns={[1, 2, 3, 3]} spacing="4">
        {iconComponents.map((IconComponent, index) => (
          <DashboardCard
            ...
            value={metricsData[`total${iconTitles[index].replace(/\s/g, '')}`.toLowerCase()]}
            index={index}
