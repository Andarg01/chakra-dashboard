  ...
  return (
    <Flex justify="center" align="center" height="50vh">
      <Flex direction="row" align="center" wrap="wrap">
        <AnalyticsCard title=" total Shop" value={10000} data={shopData} icon={<AiOutlineShop size={24} />} />
        <AnalyticsCard title=" total Product" value={5000} data={productData} icon={<AiOutlineShopping size={24} />} />
        <AnalyticsCard title="total Order" value={30345} data={orderData} icon={<AiOutlineFileText size={24} />} />
