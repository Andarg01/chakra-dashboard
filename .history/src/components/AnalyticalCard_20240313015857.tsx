...
import { AiOutlineShop, AiOutlineShopping, AiOutlineFileText, AiOutlineStar, IoMdListBox } from 'react-icons/ai';
  ...
  return (
    <Flex justify="between" align="center" height="50vh">
      <Flex direction="row" align="center" wrap="wrap">
        ...
        <AnalyticsCard title="Category" value={45} data={categoryData} icon={<IoMdListBox size={24} />} />
      </Flex>
    </Flex>
  );
};
