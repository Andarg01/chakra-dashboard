  ...
  return (
    <div>
      ...
      <Flex justifyContent="center" mt={4}>
        <Button onClick={handlePreviousPage} disabled={currentPage === 1} bg="transparent" color="white" mr={2}>Previous</Button>
        <Button onClick={handleNextPage} bg="transparent" color="white">Next</Button>
      </Flex>
    </div>
  );
};
