...
const TopOrdersTable: React.FC<TopOrdersTableProps> = ({ orders, currentPage, itemsPerPage }) => {
...
const Statics: React.FC = () => {
  ...
  return (
    <div>
      <h1>Top Orders</h1>
      <TopOrdersTable orders={sampleOrders} currentPage={currentPage} itemsPerPage={itemsPerPage} />
