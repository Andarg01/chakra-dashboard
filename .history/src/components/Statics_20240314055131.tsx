  ...
  return (
    <div>
      ...
      <Flex justifyContent="center" mt={4}>
        <Button onClick={handlePreviousPage} disabled={currentPage === 1} bg="green" color="white" mr={2}>Previous</Button>
        <Button onClick={handleNextPage} bg="green" color="white">Next</Button>
      </Flex>
    </div>
  );
};
