...
import { FaTh, FaBars, FaShoppingBag, FaShoppingCart } from 'react-icons/fa';
      ...
      >
        ...
        >
          <IconButton
            ...
            onClick={toggle}
          />
          <Box fontSize={isOpen ? '30px' : '0'} className="logo" marginTop="2">
            <FaShoppingCart />
          </Box>
        </Flex>
        {menuItems.map((item, index) => (
          <NavLink to={item.path} key={index} className="link">
            ...
            >
              <Box className="icon" marginRight="2">
                {item.icon}
              </Box>
            </Flex>
          </NavLink>
