...
const ProductTable: React.FC<ProductTableProps> = ({
  ...
  return (
    ...
    >
      ...
      <Modal isOpen={deleteConfirmationModalOpen} onClose={() => setDeleteConfirmationModalOpen(false)} size="md">
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Delete Confirmation</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            {`Are you sure you want to delete product with ID: ${selectedProduct}?`}
          </ModalBody>
          <ModalFooter>
            <Button
              colorScheme="pink"
            ...
            <Button variant="ghost" onClick={() => setDeleteConfirmationModalOpen(false)}>Cancel</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
