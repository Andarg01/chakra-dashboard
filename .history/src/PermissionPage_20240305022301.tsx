...
//   };
  ...
  return (
    <Box boxShadow="xl" mb='4'>
        <Button onClick={handleCreate} mb={4} position="relative" top="50px " right="500px">
        Create
      </Button>
   
      <Stack  spacing={4} mb={4} align="center" width='sm' position="relative" left="700px" top="20px">

        <InputGroup size="sm" ml="auto"> {/* ml="auto" pushes it to the right corner */}
      ...
      <Button
        ...
        onClick={prevPage}
        mr={4} // Set right margin to create a gap of 4 pixels
      >
        Previous
      </Button>
      <Button
        ...
        onClick={nextPage}
        ml={4} // Set left margin to create a gap of 4 pixels
      >
        Next
      </Button>
    </Box>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button colorScheme="pink" onClick={handleSave}>Save</Button>
            <Button onClick={onClose} colorScheme='indigo'>Cancel</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
    </Box>
