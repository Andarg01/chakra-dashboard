          ...
          {sortedProducts.map((product) => (
            <Tr key={product.id} borderBottom="1px">
              ...
              <Td py={2} px={4} fontWeight="normal">
                <Button onClick={() => handleEdit(product)} className="edit  text-purple-700 hover:underline mr-2 hover:text-purple-700">
                  Edit
                </Button>
                <Button onClick={() => onDelete(product.id)} className="delete text-red-800 hover:underline hover:text-red-700">
                  Delete
                </Button>
              </Td>
            </Tr>
